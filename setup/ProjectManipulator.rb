...
module Pod
  ...
  class ProjectManipulator
    ...
    def remove_demo_project
      ...
      `rm -rf templates/Example/PROJECT`
...
RUBY
    ...
    def rename_files
      ...
      # rename xcproject
      File.rename(project_folder + "/PROJECT.xcodeproj", project_folder + "/" +  @configurator.pod_name + "_Example.xcodeproj")

      # rename bridging header
      # File.rename(project_folder + "/PROJECT/PROJECT-Bridging-Header.h" , project_folder + "/PROJECT/" +  @configurator.pod_name + "-Bridging-Header.h")


      File.rename(project_folder + "/POD_NAMETests", project_folder + "/" + @configurator.pod_name + "Tests")
      File.rename(project_folder + "/" + @configurator.pod_name + "Tests/POD_NAMETests.swift", project_folder + "/" + @configurator.pod_name + "Tests/" + @configurator.pod_name + "Tests.swift")

      File.rename(project_folder + "/PROJECTExampleUITests", project_folder + "/" + @configurator.pod_name + "_ExampleUITests")
      File.rename(project_folder + "/" + @configurator.pod_name + "_ExampleUITests/PROJECTExampleUITests.swift", project_folder + "/" + @configurator.pod_name + "_ExampleUITests/" + @configurator.pod_name + "_ExampleUITests.swift")

      File.rename(project_folder + "/PROJECTExampleTests", project_folder + "/" + @configurator.pod_name + "_ExampleTests")
      File.rename(project_folder + "/" + @configurator.pod_name + "_ExampleTests/PROJECTExampleTests.swift", project_folder + "/" + @configurator.pod_name + "_ExampleTests/" + @configurator.pod_name + "_ExampleTests.swift")
    ...
    def rename_project_folder
      if Dir.exist? project_folder + "/PROJECT"
        File.rename(project_folder + "/PROJECT", project_folder + "/" + @configurator.pod_name + "_Example")
      end
    end
